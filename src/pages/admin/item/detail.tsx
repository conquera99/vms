...
import { CloseOutline, GiftOutline, RightOutline } from 'antd-mobile-icons';
						...
						<div className="flex flex-col gap-3 sm:min-w-72">
							<div className="grid grid-cols-3 gap-3">
								...
								<div className="rounded-2xl border border-amber-200 bg-white/90 px-4 py-3 text-center shadow-sm">
									...
									<p className="mt-2 text-2xl font-black text-slate-800">{usedQty}</p>
								</div>
								<div className="rounded-2xl border border-amber-200 bg-white/90 px-4 py-3 text-center shadow-sm">
									<p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
										Tersedia
									</p>
									<p className="mt-2 text-2xl font-black text-slate-800">{availableQty}</p>
								</div>
							</div>
							<LinkButton
								href="/admin/item"
						...
						<div className="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm">
							...
							<div className="mt-4 space-y-3">
								<div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
									...
									<p className="mt-1 text-2xl font-black text-slate-800">{totalQty}</p>
								</div>
								<div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
								...
								<div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3">
									...
									<p className="mt-1 text-2xl font-black text-emerald-900">{availableQty}</p>
								</div>
							</div>
						</div>
