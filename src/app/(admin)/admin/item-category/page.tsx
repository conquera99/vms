...
import { AddOutline, LeftOutline, TagOutline } from 'components/general/antd-icon';
...
const Page = () => {
	...
	return (
		<Navigation title="VMS: Data Kategori Item" active="admin" access="item_category" isAdmin>
			<Container>
				<div className="rounded-3xl border border-slate-200 bg-linear-to-br from-cyan-50 via-white to-amber-50 p-5 shadow-sm md:p-6">
					<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
						<div>
							...
							<p className="text-sm text-slate-600">Kelola kategori untuk pengelompokan item vihara.</p>
						</div>
						<div className="flex w-full flex-col items-end gap-2 md:w-auto">
							<div className="min-w-36 rounded-2xl border border-cyan-200 bg-cyan-50 px-4 py-2 text-cyan-900 shadow-sm">
								<div className="flex items-center justify-between gap-3">
									...
									<TagOutline className="text-xl text-cyan-700" />
								</div>
							</div>
							<div className="flex flex-wrap items-center justify-end gap-2">
								...
								<LinkButton
									href="/admin/item-category/create"
									size="small"
									buttonType="success"
									icon={<AddOutline />}
									className="text-base"
				...
				{isEmpty && (
					<Empty
						...
						desc="Tambahkan kategori baru untuk mengelompokkan item vihara."
						action={
							<LinkButton
								href="/admin/item-category/create"
								size="small"
