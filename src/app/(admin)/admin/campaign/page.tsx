...
import { AddOutline, CalendarOutline, LeftOutline } from 'components/general/antd-icon';
...
const Page = () => {
	...
	return (
		<Navigation title="VMS: Data Campaign" active="admin" access="campaign" isAdmin>
			<Container>
				<div className="rounded-3xl border border-slate-200 bg-linear-to-br from-cyan-50 via-white to-amber-50 p-5 shadow-sm md:p-6">
					<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
						<div>
							...
							<h1 className="mt-3 text-2xl font-bold text-slate-800">Data Campaign</h1>
							<p className="text-sm text-slate-600">Kelola campaign dan donasi vihara.</p>
						</div>
						<div className="flex w-full flex-col items-end gap-2 md:w-auto">
							<div className="min-w-36 rounded-2xl border border-cyan-200 bg-cyan-50 px-4 py-2 text-cyan-900 shadow-sm">
								<div className="flex items-center justify-between gap-3">
									...
									<CalendarOutline className="text-xl text-cyan-700" />
								</div>
							</div>
				...
				{isEmpty && (
					<Empty
						...
						desc="Tambahkan campaign baru untuk kegiatan donasi vihara."
						action={
							<LinkButton
								href="/admin/campaign/create"
								size="small"
